...
public class MyCalendar {
	...
	public static int getYear() {
		Scanner reader = new Scanner(System.in);
		System.out.print("Enter a year you want to print: ");
	...
	public static int getMonth() {
		Scanner reader = new Scanner(System.in);
		System.out.print("Enter a month you want to print: ");
	...
	public static void printCalendar(int year, int month, int dayMax, int dayWeek1) {
		...
		for (int j = 1; j <= dayMax; j++) {
			...
			if ((dayWeek1 - 1 + j) % 7 == 0) { // blank = (dayWeek1 - 1) + j -> a week in one line
				System.out.println();
			}
		}
		System.out.println("\n");
